...
${OBJECTDIR}/Practika1GL7.o: nbproject/Makefile-${CND_CONF}.mk Practika1GL7.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Practika1GL7.o Practika1GL7.cpp
