...
${OBJECTDIR}/Practika3GL9.o: nbproject/Makefile-${CND_CONF}.mk Practika3GL9.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Practika3GL9.o Practika3GL9.cpp
